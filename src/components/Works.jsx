  ...
  return (
    <motion.div variants={fadeIn("up", "spring")}>
      <Tilt
        ...
        className="bg-tertiary/20 backdrop-blur-lg p-5 rounded-2xl sm:w-[360px] w-full border border-white/10 hover:shadow-2xl transition-all duration-300 relative group overflow-hidden"
      >
